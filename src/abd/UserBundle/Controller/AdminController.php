...
use AppBundle\Form\BannerAdminType;
...
class AdminController extends BaseAdminController
{
    ...
    public function createBannersNewForm(Banner $entity)
    {
        $bannerType = new BannerAdminType();
        $form = $this->createForm($bannerType, $entity, array());
        $form->add('submit', 'submit', array('label' => 'Guardar Cambios'));
        return $form;
    }

    public function createBannersEditForm(Banner $entity)
    {
        $bannerType = new BannerAdminType();
        $form = $this->createForm($bannerType, $entity, array('image_required' => false));
        $form->add('submit', 'submit', array('label' => 'Guardar Cambios'));
        return $form;
    }
