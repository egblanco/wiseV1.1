...
class DefaultController extends Controller
{
    public function indexAction(Request $request)
    {
        ...
        $banner = $em->getRepository('AppBundle:Banner')->getByTipo(1);
    ...
    public function carsAction(Request $request)
    {
        ...
        $banner = $em->getRepository('AppBundle:Banner')->getByTipo(2);
...
//
        ...
        $banner = $em->getRepository('AppBundle:Banner')->getByTipo(3);
...
//
    ...
    public function greatDealsAction(Request $request)
    {
        ...
        $banner = $em->getRepository('AppBundle:Banner')->getByTipo(4);
    ...
    public function contactUsAction(Request $request)
    {
        ...
        $banner = $em->getRepository('AppBundle:Banner')->getByTipo(7);
    ...
    public function travelTipsAction(Request $request)
    {
        ...
        $banner = $em->getRepository('AppBundle:Banner')->getByTipo(6);
    ...
    public function faqsAction(Request $request)
    {
        ...
        $banner = $em->getRepository('AppBundle:Banner')->getByTipo(5);
